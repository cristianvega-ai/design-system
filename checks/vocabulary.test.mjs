...
// Ruling R31. Two words the sheet and the products document must not carry.
//
// 1. "paper". Release 2.0.0 retired that ground. The light page is surface and its recess is
//    surface-well, called the well. The word is banned in descriptive text, in a class attribute,
//    in a custom property name, and in a label. Ruling R38 adds the labels: two of the ten places
//    release 2.1.0 fixed sat in an aria-label, which no other scan reads, so a label is checked
//    too, both the aria-label text and the text of every element an aria-labelledby names.
